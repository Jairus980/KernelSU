...
static long (*old_compat_newfstat)(unsigned int fd, struct compat_stat __user * statbuf);
static long hook_compat_newfstat_ret(unsigned int fd, struct compat_stat __user * statbuf)
{
	// we handle it like rp
